...
public class TrappedRusticChestBlock extends TrappedThemedChestBlock {
    ...
    public TrappedRusticChestBlock(Theme theme, Settings settings) {
    ...
    protected ChestDecoratableData.ChestTextureContext createTextureContext(Theme theme, BlockEntity blockEntity, ChestType type, boolean christmas) {
        return new RusticChestDecoratableData.RusticChestTextureContext(theme, type, true, blockEntity.getCachedState().get(TREASURE));
    }
}
